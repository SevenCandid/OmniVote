...
from app.modules.election.routes import voters as election_voters_routes
...
api_router.include_router(election_voters_routes.router, prefix="/organizations/{organization_id}/elections/{election_id}/voters", tags=["Election Voters"])
