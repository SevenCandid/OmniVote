...
export function ForbiddenPage() {
  return (
    <div className="flex flex-col items-center justify-center text-center p-8 gap-4 max-w-md mx-auto">
      ...
      <p className="text-sm text-[var(--color-neutral-secondary-light)] dark:text-[var(--color-neutral-secondary-dark)]">
        You do not have the credentials or privileges required to access this
        resource context.
      </p>
      <Link to="/" className="w-full mt-4">
        <BaseButton variant="primary" className="w-full cursor-pointer">
...
export function ServerErrorPage() {
  return (
    <div className="flex flex-col items-center justify-center text-center p-8 gap-4 max-w-md mx-auto">
      ...
      <p className="text-sm text-[var(--color-neutral-secondary-light)] dark:text-[var(--color-neutral-secondary-dark)]">
        An unexpected error occurred on our end. Rest assured, our engineering
...
export function MaintenancePage() {
  return (
    <div className="flex flex-col items-center justify-center text-center p-8 gap-4 max-w-md mx-auto">
      ...
      <h2 className="text-base font-bold text-[var(--color-neutral-secondary-light)] dark:text-[var(--color-neutral-secondary-dark)]">
        System Upgrades in Progress
      </h2>
      <p className="text-sm text-[var(--color-neutral-secondary-light)] dark:text-[var(--color-neutral-secondary-dark)]">
        We are executing scheduled platform upgrades. We will be back online
