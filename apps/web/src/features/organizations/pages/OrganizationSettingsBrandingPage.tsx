...
import { useOrganization, useUpdateOrganization, useUpdateOrganizationBranding } from '../hooks/useOrganizations';
...
export const OrganizationSettingsBrandingPage: React.FC = () => {
  ...
  const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>, field: 'logo_url' | 'banner_url') => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const sanitizedOrgData = {
      ...
      contact_email: formData.contact_email === '' ? null : formData.contact_email,
    };
    ...
    updateBrandingMutation.mutate({
      ...
      data: {
        ...
        logo_url: formData.logo_url?.startsWith('data:') ? null : (formData.logo_url || null),
        banner_url: formData.banner_url?.startsWith('data:') ? null : (formData.banner_url || null),
      }
    }, {
      onSuccess: () => {
        setIsSuccess(true);
  ...
  const isPending = updateOrgMutation.isPending || updateBrandingMutation.isPending;
  ...
  return (
    <div className="flex flex-col 2xl:flex-row gap-8">
      ...
      <div className="flex-1 space-y-6">
        <div>
          <h2 className="text-xl font-bold text-gray-900 dark:text-white">Branding & Profile</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {updateBrandingMutation.isError && (
            <div className="bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 p-4 rounded-xl text-sm">
              <p className="font-semibold">Failed to update organization branding</p>
              <p>
            ...
            <div className="p-6 space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Short Name (Slug)</label>
                    <input
                      type="text"
                      name="slug"
                      value={formData.slug}
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div className="flex items-center gap-4">
                      {formData.logo_url ? (
                        <div className="relative h-16 w-16 rounded-full overflow-hidden border border-gray-200 dark:border-gray-700">
                          <img src={formData.logo_url} alt="Logo" className="object-cover h-full w-full" />
                          <button
                            type="button"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Banner (Optional)</label>
                    <div className="flex items-center gap-4">
                      {formData.banner_url ? (
                        <div className="relative h-16 w-32 rounded-md overflow-hidden border border-gray-200 dark:border-gray-700">
                          <img src={formData.banner_url} alt="Banner" className="object-cover h-full w-full" />
                          <button
                            type="button"
      ...
      <div className="w-full lg:w-80 xl:w-96 flex-shrink-0">
        <div className="sticky top-6 space-y-6">
          <div>
            ...
            <p className="text-xs text-gray-400 mt-1">See how your colors affect the UI components.</p>
          </div>
          ...
          <div className="bg-white dark:bg-[#18181B] border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden shadow-sm">
            ...
            <div 
              ...
              style={formData.banner_url ? { backgroundImage: `url(${formData.banner_url})` } : { backgroundColor: formData.secondary_color }}
            />
            ...
            <div className="p-5">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 mb-4 line-clamp-2">
                {formData.description || 'Your organization description will appear here...'}
              </p>
              
              <div className="space-y-4">
                <div>
                  <label className="text-xs font-semibold text-gray-500 mb-2 block">Buttons</label>
                ...
                <div>
                  <label className="text-xs font-semibold text-gray-500 mb-2 block">Badges & Highlights</label>
                ...
                <div>
                  <label className="text-xs font-semibold text-gray-500 mb-2 block">Interactive State</label>
                  <div 
                    className="p-3 rounded-md border flex items-center justify-between"
                    style={{ borderColor: formData.primary_color, backgroundColor: `${formData.primary_color}0a` }}
                  >
                    <span className="text-sm font-medium" style={{ color: formData.primary_color }}>Selected Option</span>
                    <Check size={16} style={{ color: formData.primary_color }} />
                  </div>
                </div>
              </div>
