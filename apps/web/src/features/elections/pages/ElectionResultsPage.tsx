  ...
  if (resultsError) {
    return (
      <div className="flex flex-col items-center justify-center p-12 bg-white dark:bg-[#18181B] rounded-xl border border-gray-200 dark:border-gray-800 text-center">
        ...
        <h3 className="text-lg font-medium text-gray-900 dark:text-white">Failed to Load Results</h3>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white dark:bg-[#18181B] p-5 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm flex items-start space-x-4">
        ...
        <div className="bg-white dark:bg-[#18181B] p-5 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm flex items-start space-x-4">
          ...
          <div>
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Expected Voters</p>
            <p className="text-2xl font-bold text-gray-900 dark:text-white mt-1">
        ...
        <div className="bg-white dark:bg-[#18181B] p-5 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm flex items-start space-x-4">
          ...
          <div>
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Turnout</p>
            <p className="text-2xl font-bold text-gray-900 dark:text-white mt-1">
