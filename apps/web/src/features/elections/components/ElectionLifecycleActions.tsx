        ...
        <div className="flex flex-wrap gap-4">
          {(election.status === 'draft' || election.status === 'configured') &&
            canPublish && (
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 text-sm bg-blue-50 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400 font-medium rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/50 disabled:opacity-50 transition-colors"
              >
                <CheckCircle size={16} />
                Publish Election
              </button>
          ...
          {election.status === 'published' && canOpenVoting && (
            <button
              ...
              className="flex items-center gap-2 px-3 py-1.5 text-sm bg-green-50 text-green-700 dark:bg-green-900/30 dark:text-green-400 font-medium rounded-lg hover:bg-green-100 dark:hover:bg-green-900/50 disabled:opacity-50 transition-colors"
            >
              <Play size={16} />
              Open Voting
            </button>
          ...
          {election.status === 'voting_open' && canPauseVoting && (
            <button
              ...
              className="flex items-center gap-2 px-3 py-1.5 text-sm bg-yellow-50 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400 font-medium rounded-lg hover:bg-yellow-100 dark:hover:bg-yellow-900/50 disabled:opacity-50 transition-colors"
            >
              <Pause size={16} />
              Pause Voting
            </button>
          ...
          {(election.status === 'voting_open' ||
            ...
            canCloseVoting && (
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 text-sm bg-orange-50 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400 font-medium rounded-lg hover:bg-orange-100 dark:hover:bg-orange-900/50 disabled:opacity-50 transition-colors"
              >
                <StopCircle size={16} />
                Close Voting
              </button>
          ...
          {[
            ...
            canCancel && (
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 text-sm bg-red-50 text-red-700 dark:bg-red-900/30 dark:text-red-400 font-medium rounded-lg hover:bg-red-100 dark:hover:bg-red-900/50 disabled:opacity-50 transition-colors ml-auto"
              >
                <XCircle size={16} />
                Cancel Election
              </button>
          ...
          {['results_published', 'cancelled', 'voting_closed'].includes(
            ...
            canArchive && (
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 text-sm bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-300 font-medium rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 disabled:opacity-50 transition-colors ml-auto"
              >
                <Archive size={16} />
                Archive Election
              </button>
