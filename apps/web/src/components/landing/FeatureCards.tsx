...
export const FeatureCards = () => {
  ...
  return (
    <section className="relative py-32 px-4 max-w-7xl mx-auto w-full z-10 bg-transparent transition-colors duration-500">
      <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
        ...
        <div className="lg:w-1/3 flex flex-col justify-center sticky top-32 h-fit">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-light text-gray-900 dark:text-white mb-6 leading-tight tracking-tight">
              Security without <br />
        ...
        <div className="lg:w-2/3 flex flex-col gap-12 mt-12 lg:mt-0">
          {features.map((feature, idx) => (
            ...
            >
              ...
              <div className="flex flex-col justify-center border-b border-gray-200 dark:border-white/5 pb-12 w-full group-hover:border-gray-300 dark:group-hover:border-white/20 transition-colors duration-500">
                <h3 className="text-2xl font-medium text-gray-900 dark:text-white mb-3 tracking-wide">
                  {feature.title}
                </h3>
                <p className="text-gray-600 dark:text-gray-400 font-light leading-relaxed text-lg max-w-lg">
                  {feature.description}
                </p>
              </div>
            </motion.div>
